...
import { light } from "../../../_styles/Palette";
import { sendGA4ContactIcon } from "../../GoogleAnalytics/EventFunctions";
...
const CommLinks = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Mail color={light.main} size={size} strokeWidth={1.1} />
      </Link>
      <Link
        href="tel:353862321667"
        onClick={() => sendGA4ContactIcon("Mobile")}
      >
        <Phone color={light.main} size={size} strokeWidth={1.1} />
      </Link>
      <Link
      ...
      >
        <Linkedin color={light.main} size={size} strokeWidth={1.1} />
      </Link>
      <Link
      ...
      >
        <GitHub color={light.main} size={size} strokeWidth={1.1} />
      </Link>
      <Link
      ...
      >
        <Dribbble color={light.main} size={size} strokeWidth={1.1} />
      </Link>
      <Link
      ...
      >
        <Instagram color={light.main} size={size} strokeWidth={1.1} />
      </Link>
    </Stack>
  );
};
