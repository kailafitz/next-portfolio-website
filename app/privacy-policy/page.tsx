      ...
      >
        ...
        <Typography variant="body2">
          <b>
            ...
            below to find the section vou are looking for.
          </b>
          <br />
          <br />
          <b>What personal data do we process?</b> When you visit, use or
        ...
        <Typography variant="body2">
          ...
          months data retention on events and 14 months data retention for
          users.
          <br />
          <br />
        ...
        <Typography variant="body2">
          ...
          <Link href="/#contact">mikhailafitzpatrick.com/#contact</Link>, by
          email at{" "}
          <Link href="mailto:mikhailafitzpatrick@gmail.com">
            mikhailafitzpatrick@gmail.com
          </Link>
        ...
        <Typography variant="body2">
          ...
          or visit{" "}
          <Link href="/#contact">mikhailafitzpatrick.com/#contact</Link>
          .
          <br />
          <br />
          If we decline to take action regarding your request and you wish to
        ...
        <Typography variant="body2">
          ...
          your appeal is denied, you may contact the Attorney General to submit
          a complaint.
        </Typography>
        ...
        <Typography variant="body2">
          ...
          our Data Protection Officer (DPO), Mikhaila Fitzpatrick, by email at{" "}
          <Link href="mailto:mikhailafitzpatrick@gmail.com">
            mikhailafitzpatrick@gmail.com
          </Link>
